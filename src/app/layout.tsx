...
export const metadata: Metadata = {
  title: "RentSearch - Find Your Perfect Rental Apartment",
  description: "Search thousands of rental apartments and homes. Filter by location, price, and amenities to find your ideal place to call home.",
  keywords: "apartment rental, housing search, rent apartment, rental listings, property search",
  metadataBase: new URL("https://rentsearch.com"),
  alternates: {
    canonical: "https://rentsearch.com"
  },
  openGraph: {
    title: "RentSearch - Find Your Perfect Rental Apartment",
    description: "Search thousands of rental apartments and homes. Filter by location, price, and amenities to find your ideal place to call home.",
